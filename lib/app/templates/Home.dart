          ...
          child: Column(
            children: [
              ...
              FloatingActionButton(
                heroTag: "dtals",
                onPressed: (){
                  Navigator.pushNamed(bc, "/detalhes");
                },
                child: Text("Detalhes"),
              ),
            ],
        ...
        drawer: Drawer(
          child: ListView(
            children: [
              ...
              ListTile(title: Text("Buscar"), onTap: (){Navigator.pushNamed(bc, "/buscar");},),
              ...
              ListTile(title: Text("Logout"), onTap: (){Navigator.of(bc).pushReplacement(MaterialPageRoute(builder: (bc) => Login()));},),
